# Prediction  restaurant ratings

Utilized model - RandomForestRegression

Это каггловское соревновение, у в котором у нас есть датасет, содержащий сведения о ресторанах. Необходимо создать модель, использующую алгоритм RandomForestRegression, которая будет прогнозировать рейтинг ресторана по версии TripAdvidor.
